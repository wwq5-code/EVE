#Fig. 9. Performance Comparison by Grading Software in Proposal Writing of Teacher Identity
...
gpt_only = [84, 75, 80, 92]
model_only = [85, 56, 82, 92]
gpt_assisted = [86, 69, 80, 93]
model_assisted = [86, 69, 83, 92]
...
output_path = "fig9_Comparison_by_Grading_Software_in_Proposal_Writing_of_Teacher_Identity.pdf"
