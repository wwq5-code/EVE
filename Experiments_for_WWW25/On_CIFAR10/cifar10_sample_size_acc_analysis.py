...
unl_mib = [0.77284, 0.7736, 0.767836, 0.76773, 0.7167538 ]

unl_cap = [0.7803, 0.7935, 0.7881, 0.7842, 0.7281]
...
my_y_ticks = np.arange(0.68, 0.85, 0.03)
...
plt.savefig('cifar10_sample_size_acc_analysis.pdf', format='pdf', dpi=200)
plt.show()